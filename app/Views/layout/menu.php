<li class="menu-header">Dashboard</li>
    ...
    <li class="#"><a class="nav-link" href="#"><i class="fas fa-calendar-alt"></i> <span>Jurnal Umum</span></a></li>
    <li class="#"><a class="nav-link" href="#"><i class="fas fa-beer"></i> <span>Posting</span></a></li>
    <li class="#"><a class="nav-link" href="#"><i class="fas fa-balance-scale"></i> <span>Neraca Saldo</span></a></li>
    <li class="#"><a class="nav-link" href="#"><i class="far fa-square"></i> <span>Neraca Lajur</span></a></li>
        <li class="nav-item dropdown">
