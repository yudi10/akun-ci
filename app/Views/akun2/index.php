                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width:15%">
                                        ...
                                        <form action="<?=site_url('akun2/'.$value->id_akun2)?>" method="post" id="del-<?=$value->id_akun2?>" class="d-inline">
                                            ...
                                            <button class="btn btn-danger btn-small" data-confirm="Anda yakin Menghapus data ini..!" data-confirm-yes="hapus(<?=$value->id_akun2?>)"><i class="fas fa-trash"></i> Del</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
